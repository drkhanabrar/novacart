...
import { TrackProductView } from "@/components/NovaTracker";
import { formatCurrency } from "@/lib/utils";

/*
 * params is a Promise in Next.js 15+.
 *
 * This page destructured it synchronously, so params.slug was undefined and the
 * Prisma lookup failed with "needs at least one of id or slug". The bug only
 * surfaced once the storefront finally had a visible product to click into -
 * before that, nobody ever reached a product detail page.
 */
