...
import { recordPurchaseEvents } from "@/lib/services/purchase-telemetry";
...
export async function createOrder(
  ...
  try {
    ...
    /*
     * Purchases are recorded server-side only.
     *
     * A PURCHASE event accepted from the browser could be forged, and every
...
export async function markOrderPaid(input: {
  ...
  try {
    ...
    // Same rule as the COD path: purchase truth originates on the server.
